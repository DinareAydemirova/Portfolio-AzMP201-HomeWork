const api = [
  ...
  const basketBtns = document.querySelectorAll(".prodBasketBtn");
  ...
  const favoriteBtns = document.querySelectorAll(".prodFavBtn");
  
  for (let fovBtn of favoriteBtns) {
    fovBtn.addEventListener("click", (e) => {
