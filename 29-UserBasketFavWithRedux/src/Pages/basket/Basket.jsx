...
import { removeFromBasket, removeAll, decrementQuantity, incrementQuantity } from "../../redux/slices/cardSlices";
...
const Basket = () => {
  ...
  return (
    <div>
          ...
          <div key={index}>
            <section className="py-10 relative">
              <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
                <div className="rounded-3xl border-2 border-gray-200 p-4 lg:p-8 grid grid-cols-12  max-lg:max-w-lg max-lg:mx-auto  ">
      ...
      <div className="w-full max-w-7xl mb-20 md:px-5 lg-6 mx-auto">
        ...
        <div className="max-lg:max-w-lg max-lg:mx-auto">
          ...
          <button
            className="rounded-full py-4 px-6 bg-red-600 text-white font-semibold text-lg w-full text-center transition-all duration-500 hover:bg-red-700 "
