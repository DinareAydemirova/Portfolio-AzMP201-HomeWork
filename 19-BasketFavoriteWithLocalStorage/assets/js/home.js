...
<div class="card">
      ...
      <div class="card-content">
        ...
        <button data=${
          elem.id
        } class="button addToBasket"><i class="fas fa-shopping-basket"></i> Add to Basket</button>
        <button class="button addToFavorite"><i class="fas fa-heart"></i> Add to Favorites</button>
      </div>
    </div>
   </div>
`;
...
for (const basketButton of basketButtons) {
  basketButton.addEventListener("click", (e) => {
    ...
    if (checkItem) {
      checkItem.count = checkItem.count + 1;
